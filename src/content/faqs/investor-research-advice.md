---
title: "What advice would you give new investors starting research?"
metaTitle: "What advice would you give new investors starting research? | Retirement Citizenship"
metaDescription: "Expert framework for researching investment migration: due diligence criteria, red flags in the advisory industry, trusted government and independent sources, and how to verify program claims."
category: "faq"
question: "What advice would you give new investors starting research?"
order: 9
---
...
- AIMA (Portugal): [aima.gov.pt](https://aima.gov.pt)
- Tax and Customs Authority Portugal: [portaldasfinancas.gov.pt](https://portaldasfinancas.gov.pt)
- Spain's General Consulate websites (country-specific)
- Residency Malta Agency: [residencymalta.gov.mt](https://residencymalta.gov.mt)
- Italy Ministry of Economy and Finance: [mef.gov.it](https://mef.gov.it)
...
For a complete picture of what you need to qualify financially for the programs you're evaluating, see our [getting started guide](/faqs/getting-started). For the document requirements that apply once you've selected a program, see our [documents and processes](/faqs/documents-and-processes) page. For the tax implications that should inform your program selection, see our [tax implications](/faqs/tax-implications) page.
